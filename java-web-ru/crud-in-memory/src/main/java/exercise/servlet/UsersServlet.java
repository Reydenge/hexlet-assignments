...
public class UsersServlet extends HttpServlet {
    ...
    private void createUser(HttpServletRequest request,
        ...
        if (newUserFirstName.isEmpty() || newUserLastName.isEmpty() || newUserEmail.isEmpty()) {
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("/new.jsp");
            request.setAttribute("user", newUser);
            request.setAttribute("error", "Данные пользователя введены некорректно");
    ...
    private void updateUser(HttpServletRequest request,
        ...
        // BEGIN
        String userNewFirstName = request.getParameter("firstName");
        String userNewLastName = request.getParameter("lastName");
        String userNewEmail = request.getParameter("email");
        user.replace("firstName", user.get("firstName"), userNewFirstName);
        user.replace("lastName", user.get("lastName"), userNewLastName);
        user.replace("email", user.get("email"), userNewEmail);
        //проверка на корректность новых данных
        if (userNewFirstName.isEmpty() || userNewLastName.isEmpty()) {
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("/edit.jsp");
            request.setAttribute("users", users);
